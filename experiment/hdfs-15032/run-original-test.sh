#!/usr/bin/env bash
cd /vagrant/rw/Anduril/experiment/hdfs-15032
 
SCRIPT_DIR="$( cd "$( dirname "${BASH_SOURCE[0]}" )" &> /dev/null && pwd )"

hd_dir="${SCRIPT_DIR}/../../systems/hdfs-15032"
...
testcase="org.apache.hadoop.hdfs.server.balancer.TestBalancerWithHANameNodes"
